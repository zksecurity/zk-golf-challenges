...
import Challenge.Instances.Secp256k1ScalarMul.Cost

/-!
Trusted statement template for the secp256k1 scalar-multiplication instance.
...
open Challenge.Instances.Secp256k1ScalarMul.Interface
