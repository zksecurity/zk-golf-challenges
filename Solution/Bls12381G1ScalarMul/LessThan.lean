import Solution.Bls12381G1ScalarMul.Normalize
import Solution.Bls12381G1ScalarMul.Equal
...
private def evalValue (B : ℕ) (env : ProverEnvironment (F p))
  ...
  Solution.Bls12381G1ScalarMul.Limbs.fromLimbs B ((x.map (Expression.eval env.toEnvironment)).toList.map ZMod.val)
