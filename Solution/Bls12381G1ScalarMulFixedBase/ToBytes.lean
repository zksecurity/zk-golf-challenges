...
import Solution.Bls12381G1ScalarMulFixedBase.ToBytesTheorems
...
/-- The 48 little-endian bytes of an emulated element, as literal expressions. -/
...
/-- Witness the 48 little-endian bytes and pin them with the per-limb recomposition. -/
