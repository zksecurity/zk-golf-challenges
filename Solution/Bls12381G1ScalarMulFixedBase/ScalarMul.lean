...
import Solution.Bls12381G1ScalarMulFixedBase.ScalarMulTheorems
...
(`Specs.ShortWeierstrass.Spec`: the naive double-and-add of the complete
group law; no subgroup obligation for the fixed base point). -/
