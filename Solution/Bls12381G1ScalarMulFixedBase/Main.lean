...
import Solution.Bls12381G1ScalarMulFixedBase.MainTheorems
import Solution.Bls12381G1ScalarMulFixedBase.Cost
...
the `ScalarMul` gadget (6×64-bit little-endian limbs) with the base point
fixed to the standard generator `G`, and exports the seven comparator
obligations.
...
open Solution.Bls12381G1ScalarMulFixedBase.Cost
